							...
							if ($rootScope.packery === undefined
								...
								$rootScope.packery = new Packery(
										element[0].parentElement, {
											...
											rowHeight : 230,
											columnWidth : 230,
											itemSelector : '.toDoNoteCss'
										});
								$rootScope.packery.bindResize();
								var draggable1 = new Draggabilly(element[0]);
								$rootScope.packery
										.bindDraggabillyEvents(draggable1);

								draggable1.on('dragEnd', function(instance,
										event, pointer) {
									$timeout(function() {
								...
								var orderItems = function() {
									var itemElems = $rootScope.packery
											.getItemElements();
								...
								$rootScope.packery
										.bindDraggabillyEvents(draggable2);

								draggable2.on('dragEnd', function(instance,
										event, pointer) {
									$timeout(function() {
										$rootScope.packery.layout();
									}, 200);
